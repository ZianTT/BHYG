...
def main(cookie, voucher):
    ...
    challenge = res['challenge']
    s = res['s']
    request.urlretrieve('https://static.geetest.com/' + res['fullbg'], 'oldallbg.png')
    request.urlretrieve('https://static.geetest.com/' + res['bg'], 'oldbg.png')
    request.urlretrieve('https://static.geetest.com/' + res['slice'], 'slide.png')
    restore_picture()
    distance = get_gap()
